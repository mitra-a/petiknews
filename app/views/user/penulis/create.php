<div class="container mt-4">
    ...
    <form class="card" method="POST" action="<?= base_url ?>/userpenulis/tambah">
        <div class="card-body">
            <div class="form-group">
                <label>Nama</label>
                <input  value="<?= Flasher::MessageOld('nama') ?>" name="nama" type="text" class="form-control">
            </div>

            <div class="form-group">
                <label>Email</label>
                <input  value="<?= Flasher::MessageOld('email') ?>" name="email" type="email" class="form-control">
            </div>
